...
On the commercial and technical side, the AtoN information extends to Value-Added Resellers (VARS), as well as the Distributors and Original Equipment Manufacturers (OEMs), which are responsible for the distribution of navigational data and AtoN information to the end-users using equipment covered by SOLAS. standard. The design and implementation however of the “last-mile” solutions, is considered to be vendor-specific and outside the scope of this document.
