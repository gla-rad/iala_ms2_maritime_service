...
* PNT information on position in real time (timing is a critical component in the provision of some AtoN services, and the need to synchronize and reference radio-navigation signals to Universal Coordinated Time (UTC) will increase as look to use more diverse systems and solutions) - to be explored separately to this maritime service description

* PNT integrity (recognizing the vulnerability of radio-navigation systems to interference (e.g. GNSS jamming); the use of multiple dissimilar positioning and timing systems is required to achieve resilience in support of safe navigation and the optimal working of AtoN) - to be explored separately to this maritime service description
